        ...
        public ValidationModel Register(RegisterBinding registerBinding)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    validationModel = new ValidationModel { IsValid = true, Message = guid_.ToString(), ModelErrors = new List<State>() };
                }
                catch (Exception ex)
                {
                    validationModel = new ValidationModel { Message = ex.Message, IsValid = false, ModelErrors = new List<State>() };
                }
            }
        ...
        public ValidationModel Update(RegisterBinding registerBinding, string user_id)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    validationModel = new ValidationModel { IsValid = true, Message = user_id, ModelErrors = new List<State>() };
                }
                catch (Exception ex)
                {
